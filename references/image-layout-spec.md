...
**When to run**: if image approach includes "B) User-provided", run the scan and populate the image resource list after the Strategist's Nine Confirmations and before content analysis / outlining.
