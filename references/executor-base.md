...
11. With `concurrency=2`, spawn at most two package agents, call `sessions_yield()`, then continue with the next package batch until every `subagent_groups` item has run.
